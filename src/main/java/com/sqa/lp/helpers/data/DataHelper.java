package com.sqa.lp.helpers.data;
...
import com.sqa.lp.helpers.data.enums.*;
import com.sqa.lp.helpers.data.exceptions.*;
...
public class DataHelper {
	...
	public static Object[][] evalDatabaseTable(String driverClassString, String databaseStringUrl,
			...
			DataType[] dataTypes) throws DataTypesMismatchException, ClassNotFoundException,
	 ...
	 * @throws IOException
	 */
	private static ArrayList<Object> getNewExcelFileResults(String fileLocation, String fileName,
			Boolean hasLabels) {
	 ...
	 * @return
	 */
	private static ArrayList<Object> getOldExcelFileResults(String fileLocation, String fileName,
			Boolean hasLabels) {
		ArrayList<Object> data = null;
		String fullFilePath = fileLocation + fileName;
		InputStream newExcelFormatFile;
