...
public class AutoBasics {
	...
	public static List<WebElement> getCSSPropBasedElements(WebDriver driver, By locator,
	...
	public static String getProp(String propName, String fileLocation, String fileName,
			Logger logger) {
		...
		try {
			...
			logger.warn(
					"Can not load config properties file because it was not found: " + fileName);
		} catch (IOException e) {
	...
	public static boolean takeScreenshot(String fileLocation, String fileName, int fileNumber,
